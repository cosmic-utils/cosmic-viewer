...
pub struct CropWidget {
    ...
    img_width: u32,
    img_height: u32,
    /// Current crop selection state (cloned to ensure freshness)
...
impl CropWidget {
    ...
    /// Calculate where the image should be drawn within the widget bounds,
    /// and what scale to use. The image is centered and scaled to fit.
...
impl Widget<Message, cosmic::Theme, Renderer> for CropWidget {
    ...
    fn draw(
        ...
        renderer.draw_image(
            ...
            img_rect,
            cosmic::iced::Radians(0.0), // No rotation
            1.0, // Full opacity
            [0.0; 4], // No snap
        );

        // Draw overlay, border, and handles on top using a new layer
        // This ensures they render above the image
